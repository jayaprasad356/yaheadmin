...
define('DOMAIN_URL', 'http://localhost/yahe/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
...
class Database
{
    ...
    private $db_name = "yahe";    // Change as required
