                    ...
                    <div class="box-body">
                        ...
                        <div class='col-md-12' style="display:none">
                            <div class="form-group">
                                ...
                                <label class="radio-inline"><input type="radio" name="type" id="packate" value="packet" >Packet</label>
                                <label class="radio-inline"><input type="radio" name="type" id="loose" value="loose" checked>Loose</label>
                            </div>
                        </div>
                        ...
                        <div class="row">
                                ...
                                <div class="col-md-1" id="loose_stock_div" style="display:none">
                                    <label>Variation</label>
                        ...
                        <div class="form-group" id="loose_stock_div" >
                            <label style="display:none" for="quantity">Stock :</label> <i style="display:none" class="text-danger asterik">*</i><?php echo isset($error['quantity']) ? $error['quantity'] : ''; ?>
                            <input style="display:none" value="1000" type="number" step="any" min="0" class="form-control" name="loose_stock" required><br>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="product_pincodes" id="product_pincodes" class="form-control" required>
                                        ...
                                        <option value="all" selected>Includes All</option>
                                    </select>
                                    <br />
                                </div>
                            </div>
                        ...
                        <div class="row" style="display:none">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" id="cancelable_button" class="js-switch" checked>
                        ...
                        <div class="row" style="display:none">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" id="cod_allowed_button" class="js-switch" checked>
